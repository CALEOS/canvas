(module
 ...
 (table 4 4 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5place8setpixelEymh $_ZN5place11setcooldownEm $_ZN5place8addownerEy)
 (memory $0 1)
 ...
 (data (i32.const 1024) "expires: \00")
 (data (i32.const 1040) " and now: \00")
 (data (i32.const 1056) "not expired, updating access\n\00")
 (data (i32.const 1088) "it\'s expired\00")
 (data (i32.const 1104) "singleton does not exist\00")
 (data (i32.const 1136) "Account is already an owner \00")
 (data (i32.const 1168) "owner\00")
 (data (i32.const 1184) "Owner did not authorize this transaction: \00")
 (data (i32.const 1232) "At least one owner did not authorize this transaction\00")
 (data (i32.const 1296) "Inside color_of\n\00")
 (data (i32.const 1328) "Inside color_of, got canvas\n\00")
 (data (i32.const 1360) "Inside color_of pixel_pair is: \00")
 ...
 (func $_ZN5place8addownerEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  ...
  (block $label$4
   ...
   (call $_ZN5place18require_all_ownersEv
    (get_local $0)
   )
  )
  (block $label$6
